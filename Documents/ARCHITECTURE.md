...
- Security: displays the persisted authentication audit history for the private application. It is read-only and shows login success, login failure, logout, UTC time, source IP, and browser/client metadata only.
